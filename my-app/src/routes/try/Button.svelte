  ...
  export const buttonVariants = cva(
    'inline-flex items-center justify-center gap-2 rounded-md text-sm leading-tight transition-colors cursor-pointer outline-primary focus-visible:outline-primary focus-visible:outline-[0.125rem] focus-visible:outline-offset-[0.125rem]',
    {
      variants: {
        ...
        /** 操作できるかどうか */
        disabled: {
          true: ['!text-base-foreground-default opacity-50 pointer-events-none'],
          false: [],
        },
      },
      compoundVariants: [
        ...
        },
        {
          ...
          tone: 'solid',
          class:
            '!bg-base-container-muted !border-base-container-muted !text-base-foreground-default',
        },
        {
          variant: 'success',
          disabled: true,
...
<script lang="ts">
  ...
  let buttonVariantClass = $derived(buttonVariants({
    tone: tone,
    isSquare: isSquare,
    variant: variant,
